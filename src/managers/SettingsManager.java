...
public class SettingsManager {
  ...
  private Properties createDefaultProperties() {
    ...
    newSettings.setProperty(Settings.OUTPUT_FONT_SIZE, "18");
    newSettings.setProperty(Settings.MENU_FONT_SIZE, "18");
    newSettings.setProperty(Settings.CODE_FONT_SIZE, "18");
    ...
    newSettings.setProperty(Settings.ACCESSIBILITY_THEME,"False");
    return newSettings;
  }
